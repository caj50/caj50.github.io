...
\BeginKnitrBlock{theorem}BEGINSORTNAMEOUTMARKER-ENDSORTNAMEOUTMARKER<div class="bookdown-theorem" custom-style="TheoremStyle" id="thm:thm2"><span class="thm:thm2" custom-style="NameStyle"><strong>(\#thm:thm2)  (Weierstrass Extremal Theorem (WET)) </strong></span><p>Let $a,b \in \mathbb{R}$ with $a<b$, and let $f \in C^{0}([a,b])$. Then:
