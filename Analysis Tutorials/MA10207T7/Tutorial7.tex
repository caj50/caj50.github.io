...
Here is the material to accompany the Analysis Tutorial in Week 7. Alternative formats can be downloaded by clicking the download icon at the top of the page. As usual, send comments and corrections to \href{mailto:caj50@bath.ac.uk}{Christian Jones (caj50)}. To return to the homepage, click \href{http://caj50.github.io/tutoring.html}{here}.
...
\item
  Firstly, this is an \textbf{if and only if} statement. So you have to prove two things:
