...
\begin{figure}
\centering
\includegraphics[width=\Width,height=\Height]{/Analysis Tutorials/MA10207T7/Lim_sup_example_5.png}
...
\EndKnitrBlock{proposition}
Note that the converse of this theorem \emph{does not} hold (think of the sum \$\sum\_\{n=1\}\^{}\{\infty\} \frac{1}{n}). However, the contrapositive is very good at showing that a series does not converge!
