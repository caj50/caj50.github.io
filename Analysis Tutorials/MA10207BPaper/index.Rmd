...
# Question 2 {-}
``` {newtheorem, env = "Question"}
a)  Let $f: \mathbb{R} \to \mathbb{R}$ be given by $$f(x) = 3x^2 - 5x -1.$$ Using the *Algebra of Limits*, prove that $f$ is continuous everywhere on $\mathbb{R}$.
...
# Question 3 {-}
``` {newtheorem, env = "Question"}
a)  Let $f: \mathbb{R} \to \mathbb{R}$ be defined by $$f(x) = \begin{cases} 0 \;\; \text{if $x \leq 0$},\\
...
```{solution}
a)  Firstly, as polynomials are differentiable, we know that $f$ is differentiable on $\mathbb{R}\setminus\lbrace 0 \rbrace,$ with $$f'(x) = \begin{cases} 0 \;\; \text{if $x < 0$},\\
...
# Question 4 {-}
``` {newtheorem, env = "Question"}
a)  Give an example of a function $f:\mathbb{R} \to \mathbb{R}$ which is differentiable on $\mathbb{R}$, twice differentiable on $\mathbb{R}\setminus\lbrace 0 \rbrace$ and not twice differentiable at $0$.
...
```{solution}
a) Consider $f:\mathbb{R} \to \mathbb{R}$ given by $$f(x) = \frac{x\lvert x \rvert}{2} = \begin{cases}
