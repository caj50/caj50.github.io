...
For a sequence $(a_n)_{n\in\mathbb{N}}$, we define the limits superior and inferior to be $$\limsup_{n \to \infty} a_n := \lim_{k\to\infty}\sup_{n\geq k}a_n \;\, \text{and} \;\, \liminf_{n \to \infty} a_n := \lim_{k\to\infty}\inf_{n\geq k}a_n.$$

If $(a_n)_{n\in\mathbb{N}}$ is unbounded above, we say that $\limsup_{n \to \infty} a_n = +\infty$, and if $(a_n)_{n\in\mathbb{N}}$ is unbounded below, we set $\liminf_{n \to \infty} a_n = -\infty.$
```
