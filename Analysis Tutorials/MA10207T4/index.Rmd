...
```{definition, label = "def0", name = "Complex Numbers"}
...
```{proposition, label="prop3", name = "Triangle Inequality"}
...
A sequence of real/complex numbers is a function
\begin{align*}
...
```{definition, label = "def3", name = "Metric Space"}
...
```{definition, label = "def4", name = "Convergence"}
