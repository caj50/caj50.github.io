...
\BeginKnitrBlock{definition}BEGINSORTNAMEOUTMARKER-ENDSORTNAMEOUTMARKER<div class="bookdown-definition" custom-style="DefinitionStyle" id="def:def0"><span class="def:def0" custom-style="NameStyle"><strong>(\#def:def0)  (Complex Numbers) </strong></span><div>Given a complex number $z = a + ib,$ we define the following quantities:
...
\BeginKnitrBlock{proposition}BEGINSORTNAMEOUTMARKER-ENDSORTNAMEOUTMARKER<div class="bookdown-proposition" custom-style="TheoremStyle" id="prp:prop3"><span class="prp:prop3" custom-style="NameStyle"><strong>(\#prp:prop3)  (Triangle Inequality) </strong></span><p>For $z_1,z_2 \in \mathbb{C}$,
\begin{align*}
...
\BeginKnitrBlock{definition}BEGINSORTNAMEOUTMARKER-ENDSORTNAMEOUTMARKER<div class="bookdown-definition" custom-style="DefinitionStyle" id="def:def1"><span class="def:def1" custom-style="NameStyle"><strong>(\#def:def1)  (Sequence) </strong></span><div>A sequence of real/complex numbers is a function
\begin{align*}
...
\BeginKnitrBlock{definition}BEGINSORTNAMEOUTMARKER-ENDSORTNAMEOUTMARKER<div class="bookdown-definition" custom-style="DefinitionStyle" id="def:def3"><span class="def:def3" custom-style="NameStyle"><strong>(\#def:def3)  (Metric Space) </strong></span><div>A metric space $(X,d)$ consists of a set $X$ together with a function $d: X\times X \to \mathbb{R}$ satisfying $\forall x,y,z \in X:$ 
...
\BeginKnitrBlock{definition}BEGINSORTNAMEOUTMARKER-ENDSORTNAMEOUTMARKER<div class="bookdown-definition" custom-style="DefinitionStyle" id="def:def4"><span class="def:def4" custom-style="NameStyle"><strong>(\#def:def4)  (Convergence) </strong></span><div>Let $(X,d)$ be a metric space, let $a \in X$ and let $(a_n)_{n\in\mathbb{N}}$ be a sequence in $X$. Then $(a_n)_{n\in\mathbb{N}}$ converges to $a$ if $$\forall \epsilon > 0, \; \exists N = N(\epsilon) \in \mathbb{N}, \; \text{such that} \; \forall n \geq N, \; d(a_n,a) < \epsilon.$$</div></div>\EndKnitrBlock{definition}
