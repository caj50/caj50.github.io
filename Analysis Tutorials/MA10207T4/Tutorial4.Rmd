...
A \emph{sequence} of real numbers is a function
\begin{align*}
...
### Two Useful Theorems
```{theorem, label = "thm1", name = "Preservation of Non-Strict Inequalities"}
...
```{theorem, label = "thm2", name = "Uniqueness of Limits"}
...
```{definition, label = "def3", name = "Bounded Sequence"}
...
```{theorem, label = "thm4", name = "Algebra of Limits"}
