...
{\centering \includegraphics[width=\Width,height=\Height]{Additivity} 
...
\item
  Write the integral in the form of something you can apply the Fundamental Theorem of Calculus to. Make sure to verify the hypotheses!
\item
  See Q2) above.
\end{enumerate}
