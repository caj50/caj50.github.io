...
```{theorem, label = "thm1", name = "Additivity of the Integral"}
...
```{theorem, label = "thm2", name = "Linearity of the Integral"}
...
For $I \subseteq \mathbb{R}$ non-empty, $\lambda \in \mathbb{R}$ and $f,g:I \to \mathbb{R}$ bounded:
...
```{theorem, label="thm3", name = "Fundamental Theorems of Calculus"}
These are:
...
```{theorem, label="thm4", name = "Integration By Parts"}
...
```{theorem, label="thm5", name = "Integration By Substitution"}
