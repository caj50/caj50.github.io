...
```{definition, label = "def1", name = "Upper Bound"}
...
```{definition, label = "def2", name = "Lower Bound"}
...
```{definition, label = "def3", name = "Bounded Set"}
...
```{definition, label = "def4", name = "Supremum"}
...
```{definition, label = "def5", name = "Infimum"}
...
```{proposition, label = "prop1", name = "Archimedian Postulate"}
