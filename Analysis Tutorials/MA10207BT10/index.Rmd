...
```{r,Holder,fig.show='hold',fig.cap="An example of a Hölder continuous function. In this case, there exists constants $L$ and $\\alpha$ such that we can translate a double parabola along the function so that the function remains within the shaded areas.", fig.alt="A diagram illustrating Hölder continuity.", fig.align="center", echo=F}
show_fig("Holder")
```
