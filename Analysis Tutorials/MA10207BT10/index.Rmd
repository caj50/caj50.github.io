...
```{r,Lipschitz,fig.show='hold',fig.cap="An example of a Lipschitz continuous function. In this case, we can translate a double cone along the function, so that the function remains in the shaded area. ", fig.alt="A diagram illustrating Lipschitz continuity.", fig.align="center", echo=F}
show_fig("Lipschitz")
```
