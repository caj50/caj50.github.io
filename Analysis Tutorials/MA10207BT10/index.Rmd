...
Let $f:[a,b] \to \mathbb{R}$. Then $f$ is said to be Lipschitz continuous if $\exists L>0$ such that $\forall x,y \in [a,b]$: $$\lvert f(x) - f(y) \rvert < L \lvert x - y \rvert.$$
