...
{\label{prp:prop1} }We have that \(\forall x \in \mathbb{R}, \exists N \in \mathbb{N}\) such that \(N > x.\) In other words, the set of natural numbers \(\mathbb{N}\) is unbounded above.
...
\BeginKnitrBlock{proposition}
{\label{prp:prop4} }For \(x,y \in \mathbb{R}\):
\begin{gather*}
...
{\label{prp:prop5} }We have \(\forall n \in \mathbb{N}_0\) (i.e.~all the natural numbers with \(0\)), and \(\forall x \geq -1\), \[(1 + x)^n \geq 1 + nx.\]
\EndKnitrBlock{proposition}
